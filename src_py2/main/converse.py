...
if __name__ == "__main__":
    ...
    "Havelock Ellis claimed that necrophilia and algolagnia (sexual pleasure derived from pain, [nod yes] especially around erogenous areas) were interrelated. " \
    "Both acts refer to how [shake head no] negative effects like fear and disgust are transformed into feelings of arousal and desire."
    meta.gns(text)
