...
if __name__ == "__main__":
    ...
    "Both acts refer to how negative effects like fear and disgust are transformed into feelings of arousal and desire. So get out there and get your death on."
    meta.gns(text)
